...
def build_forecast_model_kwargs_from_config(
    ...
    *,
    ...
    kwargs = {
        ...
        "mim_stride": int(config.get("mim_stride", 1)),
        "mim_layer_norm": bool(config.get("mim_layer_norm", False)),
        "mau_hidden": str(config.get("mau_hidden", "64,64,64,64")),
        "mau_filter_size": int(config.get("mau_filter_size", 5)),
        "mau_patch_size": int(config.get("mau_patch_size", 1)),
        "mau_stride": int(config.get("mau_stride", 1)),
        "mau_sr_size": int(config.get("mau_sr_size", 4)),
        "mau_tau": int(config.get("mau_tau", 5)),
